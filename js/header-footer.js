...
const TOOLBLASTER_APPS = [
    ...
    },
    {
        ...
        apps: [
            ...
            { name: "FIRE Planner", url: "/finance/advanced-fire-retirement-planner/", icon: "fa-fire", classes: "bg-red-50 border-red-100 text-red-600 group-hover:text-red-600", matchPath: "/advanced-fire-retirement-planner/" },
...
function injectHeader() {
    ...
    if (appNameMeta && appNameMeta.content) {
        ...
        else if (currentPath.includes('/finance/advanced-fire-retirement-planner')) centerTitle = "FIRE PLANNER";
